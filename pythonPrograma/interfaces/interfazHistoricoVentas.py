...
from interfaces.interfazHistoricoItemVentas import *
from datetime import datetime

class Ui_historicoVentas(object):
    def mostrar(self):
        ...
        if index.isValid():
            ...
            self.ui=Ui_historicoItemVentas()
    ...
    def retranslateUi(self, historicoVentas):
        ...
        historicoVentas.setWindowTitle(_translate("historicoVentas", "Historico Ventas"))
