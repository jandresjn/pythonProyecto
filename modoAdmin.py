...
# Form implementation generated from reading ui file 'modoAdmin.ui'
#
...
class Ui_Form(object):
    ...
    # where c is the cursor
        ...
        #     item.setRowCount(row_number)
        #     for colum_number,data in enumerate(row_data):
        #         item.setItem(row_number,colum_number,QtWidgets.QTableWidgetItem(str(data)))
        #
        print("vamos bn")
        for row in rows:
            # print(row)
            ...
            item.setItem(inx, 0,QtWidgets.QTableWidgetItem(str(row[0])))
